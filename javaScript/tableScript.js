if (document.getElementById("pageTitle").textContent == "Order Page") {                 // Checking the page
...
// ---------------------------------------------------------------------------------------------------------
// Set order page validation
if (document.getElementById("pageTitle").textContent == "Set Order Page") {          // Checking the page
